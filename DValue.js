...
class dvalue {
    ...
    if(typeof obj != 'object') {
      ...
      if(Array.isArray(obj)) {
        rs = obj.map((k, v) => this.clone(v));
      }
      else {
        rs = Object.keys(obj).reduce((prev, curr) => {
          prev[curr] = this.clone(obj[curr]);
          return prev;
        }, {});
      }
    }
  ...
  static default(config, defaultConfig) {
